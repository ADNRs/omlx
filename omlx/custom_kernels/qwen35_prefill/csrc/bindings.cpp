...
NB_MODULE(_ext, m) {
  ...
  m.def(
      "nax_attn_kernels_built",
      &omlx::qwen35_prefill_kernels::nax_attn_kernels_built);
  m.def(
      "nax_attn_runtime_active",
      &omlx::qwen35_prefill_kernels::nax_attn_runtime_active);
  m.def(
  ...
  m.def(
      "qwen35_attn256_nax",
      &omlx::qwen35_prefill_kernels::qwen35_attn256_nax,
      "q"_a,
      "k"_a,
      "v"_a,
      "scale"_a,
