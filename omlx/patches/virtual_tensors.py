...
def register_virtual_tensors(index, config) -> int:
    ...
    quantized silently.
    """
    # Registrars claim tensors for family-specific checkpoint layouts. With
    # no registrars registered the seam is a no-op; deleted families removed
    # their registrars with them.
    return 0
